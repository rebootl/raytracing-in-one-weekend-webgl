...
const fs = `
  ...
  void main() {
    ...
    vec3 lower_left_corner = origin - horizontal / 2. - vertical / 2.
      - vec3(0, 0, focal_length);

    Ray r = Ray(
      origin,
      lower_left_corner + uv.x * horizontal + uv.y * vertical - origin
    );

    // gl_FragColor is a special variable a fragment shader
    // is responsible for setting
    gl_FragColor = vec4(rayColor(r), 1); // return reddish-purple
  }
`;
